...
- 179 tests pass locally on Python 3.14.5 with 98.49% statement coverage.
- [Public CI at the prepared commit](https://github.com/jeffglousher/spacexai-subscription-client/actions/runs/34169671109) passes at `b29c66df6833a2527fa4835aef10c46c26ed49ed` on Python 3.12, 3.13, and 3.14.
...
- [Changelog](https://github.com/jeffglousher/spacexai-subscription-client/blob/b29c66df6833a2527fa4835aef10c46c26ed49ed/CHANGELOG.md).
- [Publishing checklist](https://github.com/jeffglousher/spacexai-subscription-client/blob/b29c66df6833a2527fa4835aef10c46c26ed49ed/RELEASING.md). Follow the same verified workflow with version/tag `v0.4.0`.
