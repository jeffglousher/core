...
- 164 tests pass locally on Python 3.14.5 with 99.75% statement coverage.
- [Public CI at the prepared commit](https://github.com/jeffglousher/spacexai-subscription-client/actions/runs/34234507540) passes at `74c7e22805c2b25651f307d8f9256bbfd8dfa520` on Python 3.12, 3.13, and 3.14.
...
- [Changelog](https://github.com/jeffglousher/spacexai-subscription-client/blob/74c7e22805c2b25651f307d8f9256bbfd8dfa520/CHANGELOG.md).
- [Publishing checklist](https://github.com/jeffglousher/spacexai-subscription-client/blob/74c7e22805c2b25651f307d8f9256bbfd8dfa520/RELEASING.md). Follow the same verified workflow with version/tag `v0.3.0`.
