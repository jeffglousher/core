...
async def test_reauth_loaded_entry_reloads_once(
    ...
    assert mock_spacexai_subscription_client.async_list_models.await_args_list == [
        call(ACCESS_TOKEN),
        call("new-access-token"),
        call("new-access-token"),
    ]
    mock_flow_client.async_get_account.assert_awaited_once_with("new-access-token")
